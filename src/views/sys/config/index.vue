...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig, exportConfig } from '@/api/sys/config'
...
export default {
  ...
  created() {
    this.getList()
    this.getDicts('sys_normal_yes_no').then(response => {
